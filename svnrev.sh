...
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
	<app version="1">
		...
		<coder>USB Loader GX Team / Asayu</coder>
...
Credits:
Coding: Cyan, Dimok, nIxx, giantpune, ardi, Hungyip84, DrayX7, Lustar, r-win, WiiShizzza, Asayu
...
Links:
Asayu's USB Loader GX Project Page:
https://github.com/AsayuGit/USBLoaderGX

Original USB Loader GX Project Page 
