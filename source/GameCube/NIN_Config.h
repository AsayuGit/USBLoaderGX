...
#define NIN_CFG_VERSION				0x00000009 // ASA

typedef struct NIN_CFG 
{
	u32		Magicbytes;		// 0x01070CF6
	u32		Version;		// v4 since v3.354, v5 since v3.358, v6 since v3.368, v7 since 4.424, v8 since 4.431, v9 since 6.489 // ASA
	u32		Config;
	u32		VideoMode;
	u32		Language;
	char	GamePath[255];
	...
	union
	{
		...
		struct
		{
			...
			char		BBAProfile; 	// added in v6.489 - cfg version 9 // ASA
		};
	};
} NIN_CFG;
