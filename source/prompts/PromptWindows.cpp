...
void WindowCredits()
{
	...
	currentTxt = new GuiText(tr( "Unofficial Site:" ), 20, ( GXColor ) {255, 255, 255, 255});
	currentTxt->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	currentTxt->SetPosition(10, y);
	currentTxt->SetFont(creditsFont, creditsFontSize);
	txt.push_back(currentTxt);

	currentTxt = new GuiText("https://github.com/AsayuGit/USBLoaderGX", 20, ( GXColor ) {255, 255, 255, 255});
	currentTxt->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	...
	currentTxt = new GuiText("hungyip84 / DrayX7 / lustar / r-win / Asayu");
	currentTxt->SetAlignment(ALIGN_LEFT, ALIGN_TOP);
	currentTxt->SetPosition(160, y);
	currentTxt->SetFont(creditsFont, creditsFontSize);
	txt.push_back(currentTxt);
