...
#ifdef FULLCHANNEL
	versionTxt->SetTextf("v3.0c Rev. %s [Asayu]", GetRev());
#else
	versionTxt->SetTextf("v3.0  Rev. %s [Asayu]", GetRev());
#endif

#if 0 // enable if you release a modded version - enabled by default to differentiate official releases
