...
bool CGameSettings::Save()
{
	...
	for (u32 i = 0; i < GameList.size(); ++i)
	{
		...
		fprintf(f, "NINBBA:%d; ", GameList[i].NINBBA); // ASA
		fprintf(f, "NINBBAPROF:%d ", GameList[i].NINBBAPROF); //ASA
...
void CGameSettings::SetDefault(GameCFG &game)
{
	...
	game.NINBBA = INHERIT; // ASA
	game.NINBBAPROF = INHERIT; // ASA
